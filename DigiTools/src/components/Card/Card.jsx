...
const Card = ({ product }) => {
    ...
    return (
        <div className='flex flex-col justify-between gap-2 p-5 border border-[#d8cbcb] rounded-lg shadow-md relative'>
            ...
            <button className='btn bg-linear-to-r from-blue-500 to-purple-600 text-white border-0 rounded-full py-2 px-4 hover:from-blue-600 hover:to-purple-700'>Buy Now</button>
        </div>
    );
};
